...
/*			JOYSTICK			*/
/********************************/
class JoyTest : public ::testing::Test {
...
TEST_F(JoyTest, NoJoystickConnected) {
...
TEST_F(JoyTest, InitWithJoystick) {
...
TEST_F(JoyTest, JoyErrorHandling) {
...
TEST_F(JoyTest, JoystickSteeringAndThrottle) {
